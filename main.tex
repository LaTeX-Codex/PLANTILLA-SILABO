...
\newcommand{\asignatura}{Redes y Conectividad} % Nombre de la asignatura
\newcommand*{\thead}[1]{\multicolumn{1}{c}{\bfseries #1}} % Encabezado centrado y en negritas en tablas
