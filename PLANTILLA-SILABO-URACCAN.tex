...
\newcommand{\sede}{Sede de la Universidad} % Nombre de la sede
...
\newcommand{\requisito}{Nombre del Requisito} % Nombre del requisito (asignatura previa)
\newcommand{\codigo}{XXX-XXX} % Código de la asignatura
\newcommand{\docente}{Nombre del Docente, Ing.} % Nombre del docente
