...
\input{sections/03_competencias_u_objetivos_generales.tex}
\input{sections/04_plan_tematico.tex}
\input{sections/05_mediacion_pedagogica.tex}
\input{sections/06_evaluacion_para_los_aprendizajes.tex}
\input{sections/07_bibliografia.tex}
\input{sections/08_plan_calendario.tex}
