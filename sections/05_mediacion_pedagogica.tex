\section{Mediación Pedagógica}

\subsection*{Unidad I: \lipsum[1][1]} %! Eliminar \lipsum en producción y escribir el título de la unidad
...
%* Esta sección describe las metodologías, estrategias y técnicas que se implementarán para facilitar el aprendizaje significativo y activo de los estudiantes, según cada una de las unidades temáticas del curso.

%! Eliminar \pendiente en producción
\pendiente{Convertir de General a Unitario}
